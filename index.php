...
<html class="fixed">
	<head>
		...
		<!-- Basic -->
		<meta charset="UTF-8">
		<title>KASUTRI ASSOSIATIVES WEB APPLICATION</title>
		<meta name="keywords" content="" />
		<meta name="description" content="">

		<meta name="keywords" content="KASUTRI ASSOSIATIVES APPLICATION" />
		...
		<section class="body-sign abc">
			<div class="center-sign">
				...
				<div class= "row" style="margin-top: 70px;">
						<h3 class="text-uppercase text-bold m-none" style="text-align: center;">KASUTRI ASSOSIATIVES SOFTWARE</h3>
				</div>
				...
				<p class="text-center text-muted mt-md mb-md">&copy; Copyright 2018. All rights reserved. <a href="http://www.karteltechnosoft.com/">KTPL, BANGALORE</a>.</p>
			</div>
		</section>
		<!-- end: page -->
