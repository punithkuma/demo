								...
								<section class="panel">
									...
									<div class="panel-body">
                                        ...
                                        <div class="row">
											...
											<div class="col-sm-3" id="client" style="display:none;">
												<div class="form-group">
								...
								<section class="panel">
									...
									<div class="panel-body">
										...
										<div class="row">
                                            ...
                                            <div class="col-sm-3">
												<div class="form-group">
													<label class="control-label">APPERANCE</label>
													<input type="text" name="lastname" class="form-control">
												</div>
                                            </div>
										...
										<div class="row" style="margin-top:15px;">
											...
											<div class="col-sm-6">
												<div class="form-group">
													<label class="control-label">TOTAL AMOUNT IN WORDS</label>
													<input type="text" name="lastname" class="form-control">
												</div>
                                            </div>
							...
							<div class="col-md-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">CONTACT PERSON DETAILS</h2>
